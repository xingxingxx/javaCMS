...
<html>
	...
	<ul class="menu">
		...
		<li><a href="loginOut">退出系统</a></li>
  		...
  		<div id="right">
  			...
  			<input type="hidden" name="categoryId" value="${text.categoryId}" />
  			<table class="tab-fm"> 
  				<tr>
  					<td></td>
  					<td>
  				...
  				<tr>
  					...
  					<td>
  					 <input id="title" type="text" name="title" onblur="checkNull('title')" value="${text.title}"/>
  					</td>
  					<td id="msg_title"></td>
  				</tr>
  				<tr>
  				...
  				<tr>
  					<td>版本:</td>
  					<td>
  					<input type="text" name="edition" value="${text.edition}" /></td>
  					<td></td>
  				</tr>
  				<tr>
  					<td>是否发布:</td>
  					<td>
  					<s:if test="text.flow==1">
  ...
  <script type="text/javascript" >
 	...
 	function showResult(){
 	 ...
 	 var ue = UE.getEditor('editor',{initialContent:'${text.content}' });
 </script>
 </body>
</html>
