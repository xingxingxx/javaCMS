...
<div id="left">
	<ul class="menu">
		...
		<li><a href="loginOut">退出系统</a></li>
  		...
  		<div id="right">
  			<form action="updatePartners"  enctype="multipart/form-data" method="post">
  				<table class="tab-fm"> 
  					<tr>
  					<td>
  						标题:
  					</td>
  					<td><input type="hidden" name="partnersId" value="${p.partnersId}"/>
  						 <input id="description" type="text" name="description" value="${p.description}"/>
  					</td>
  					<td></td>
  					</tr>
  					<tr>
  					...
  					<tr>
  						<td>跳转地址:</td>
  						<td>
  							<input id="url" type="text" name="url" value="${p.url}"/>
  						</td>
  						<td></td>
  					</tr>
  					<tr>
  						<td>排序:</td>
  						<td>
  							<input id="num" type="text" name="num" value="${p.dispalyNum}"/>
  						</td>
  						<td></td>
  					</tr>
  					<tr>
