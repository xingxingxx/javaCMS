 ...
 <div id="left">
	<ul class="menu">
		...
		<li><a href="loginOut">退出系统</a></li>
  		...
  		<div id="right">
  			<form action="addTwoColumns" method="post">
  			<div id="hie"></div>
  			<table class="tab-fm"> 
  				<tr>
  					<td>
  					...
  					<td>
  						 <input id="name" type="text" name="tc.columnName" onblur="checkName()"/>
  					</td>
  					<td id="msgName"></td>
  				</tr>
  				<tr>
  					...
  					<td>
  						 <input id="position" type="text" name="tc.columnPosition" onblur="checkPostion()"/>
  					</td>
  				...
  				<tr>
  					...
  					<td>
	  					<select name="tc.columnClass">
						<option value="1">文章</option>
						<option value="2">单个页面</option>
						<option value="3">技术文档</option>
						<option value="4">下载资源</option>
