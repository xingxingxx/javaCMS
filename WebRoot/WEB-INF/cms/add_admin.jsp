...
<html>
  <head>
    <title>后台管理主页</title>
	<link href="../css/cms_base.css" rel="stylesheet" type="text/css">
  </head>
  <body>
<div id="left">
	<ul class="menu">
  		...
  		<form action="addAdmin" method="post">
  			<table class="tab-fm"> 
  				<tr>
  					...
  					<td>
  						 <input id="name" type="text" name="a.adminName" onblur="checkNull('name')"/>
  					</td>
  					<td id="msg_name"></td>
  				</tr>
  				<tr>
  					...
  					<td>
  						 <input id="password" type="text" name="a.adminPassword" onblur="checkNull('password')"/>
  					</td>
  				...
  				<tr>
  					...
  					<td>
	  					<input type="radio" name="a.adminPower" value="0" checked="checked" />
	                    <label>超级管理员</label>
	                    <input type="radio" name="a.adminPower" value="1"/>
	                    <label>管理员</label>
  					</td>
  					<td></td>
  				</tr>
...
<script type="text/javascript">
   ...
   function checkNull(id){
 	...
 	function showResult(){
 		checkNull("name");
 		checkNull('password');
 		var msg1=document.getElementById("msg_name").innerHTML;
  		var msg2=document.getElementById("msg_password").innerHTML;
 		if(msg1=="" && msg2==""){
