...
<html>
  ...
  <body>
	...
	<ul class="menu">
		...
		<li style="background-color: #eee;"><a href="docCategory">文档中心类别</a></li>
		...
		<li><a href="loginOut">退出系统</a></li>
  		...
  		<div id="right">
  			<a href="toAddDocCategory"><span class="add-icon"></span>新增类别</a><br/><br/>
	  		<table width="700px;" class="tab">
	  			<tr class="title">
	  				<td>
	  					ID
	  				</td>
	  			...
	  			<s:iterator value="list">
	  				<tr>
	  					...
	  					<td>
	  						  <a href="delDocCategory?id=<s:property value="categoryId"/>" ><span class="del-icon"></span>删除</a>
		  				<a style="margin-left:20px;" href="toUpdateDocCategory?id=<s:property value="categoryId"/>"><span class="editor-icon"></span>编辑</a>
	  					</td>
	  				</tr>
	  			</s:iterator>
	  		</table>
