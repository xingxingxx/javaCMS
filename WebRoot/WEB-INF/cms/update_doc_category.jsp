  ...
  <body>
	...
	<ul class="menu">
		...
		<li><a href="loginOut">退出系统</a></li>
  		...
  		<div id="right">
  		<form action="updateDocCategory" method="post">
  			<table class="tab-fm"> 
  				<tr>
  					<td>
  						类别名称:
  					...
  					<td>
  						<input type="hidden" name="d.categoryId" value="${d.categoryId}"/>
  						 <input id="name" type="text" value="${d.categoryName}" name="d.categoryName" onblur="checkName()"/>
  					</td>
  					<td id="msgName"></td>
  				</tr>
  				<tr>
