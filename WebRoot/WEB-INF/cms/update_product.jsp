...
<html>
  		...
  		<div id="right">
  			...
  			<table class="tab-fm"> 
  				...
  				<tr>
  					...
  					<td>
  						<input type="hidden" name="productId" value="${product.productId}" />
  						 <input id="productName" type="text" name="productName" onblur="checkNull('productName')" value="${product.productName}" />
  					</td>
  				...
  				<tr>
  					...
  					<td>
  						 <s:select theme="simple" name="categoryId" list="list"  listKey="categoryId" listValue="categoryName" value="product.categoryId" ></s:select>
  					</td>
  					<td></td>
  					</tr>
  				<tr>
  				...
  				<tr>
  					...
  					<td>
  						<textarea id="summary" name="summary" onblur="checkNull('summary')">${product.summary}</textarea>
  					</td>
  ...
  <script type="text/javascript">
    var ue1 = UE.getEditor('editorDescription',{initialContent:'${product.description}' });
    var ue2 = UE.getEditor('editorMOdel',{initialContent:'${product.model}' });
    var ue3 = UE.getEditor('editor',{initialContent:'${product.function}' });
