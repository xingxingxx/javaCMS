    ...
    up.setSavePath("../../../upload/program"); //保存路径
    ...
    up.upload();
    response.getWriter().print("{'url':'"+up.getUrl().substring(9)+"','fileType':'"+up.getType()+"','state':'"+up.getState()+"','original':'"+up.getOriginalName()+"'}");
